...
public class StudentSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString ss = new SpannableString("By Signing up you agree to our\nTerms and Privacy Policy");
        ClickableSpan clickableSpan = new ClickableSpan() {
            @Override
            public void onClick(View textView) {
                Intent m = new Intent(StudentSignUpActivity.this,web_view.class);
                m.putExtra("link","https://privacy-policy-noticeboard.netlify.app/policy");
                m.putExtra("title", "Privacy Policy");
                startActivity(m);
            }
            @Override
        ...
        ss.setSpan(clickableSpan, 30, 55, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

        tvPrivacy = findViewById(R.id.tvPrivacy);
        tvPrivacy.setText(ss);
